...
import { Brain, User, TrendingUp, BarChart3, LogOut, BookOpen, Award, Medal, Trophy } from 'lucide-react'
            ...
            {faculty.length === 0 ? (
              ...
              <div className="space-y-4">
                {faculty.map((facultyMember, index) => (
                  <div key={facultyMember.id} className="flex items-center justify-between p-4 rounded-lg border hover:bg-slate-50 transition-colors">
