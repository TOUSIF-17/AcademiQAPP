...
export default function Analytics() {
  ...
  // Note: chartType state was defined but not used in the original logic, keeping it for completeness.
  ...
  const exportData = () => {
    ...
    // Create CSV content from publicationTrends
    const csvContent = [
  ...
  const totalPublications = analytics.publicationTrends.reduce((sum, item) => sum + item.count, 0);
  const totalCitations = analytics.publicationTrends.reduce((sum, item) => sum + item.citations, 0);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-4">
            {/* Export Button (Added for completeness based on exportData function) */}
            <button
              onClick={exportData}
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={analytics.monthlyTrends}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line type="monotone" dataKey="publications" stroke="#8884d8" strokeWidth={2} name="Publications" />
                  <Line type="monotone" dataKey="citations" stroke="#82ca9d" strokeWidth={2} name="Citations" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
