      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            AcademiQ revolutionizes faculty analytics and research publication management through 
            AI-powered summarization, comprehensive profiles, and institutional insights.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                AcademiQ is an innovative AI-driven platform designed to transform how academic institutions 
                manage faculty research profiles and publications. By leveraging advanced Natural Language Processing 
                techniques, we make complex research accessible and understandable.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our platform combines extractive and abstractive summarization techniques, comprehensive faculty 
                analytics, and institutional insights to enhance research visibility and decision-making.
              </p>
        ...
        <div className="container mx-auto">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              <Image src={logo} alt="AcademiQ" className="h-16 w-auto" />
            </div>
