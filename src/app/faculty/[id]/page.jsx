...
export default function FacultyProfile() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Navbar (Reconstructed from createElement calls) */}
          ...
          <CardHeader>
            <div className="flex items-center space-x-4">
              <Avatar className="h-20 w-20">
                <AvatarImage src="" />
                <AvatarFallback className="text-2xl">{faculty.name?.charAt(0) || 'U'}</AvatarFallback>
              </Avatar>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">
                {faculty.publications.length > 0 ? Math.round(faculty.citations / faculty.publications.length) : 0}
              </div>
